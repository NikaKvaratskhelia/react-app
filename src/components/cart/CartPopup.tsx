      ...
      <div className="flex flex-col h-187.5 justify-between items-center fixed top-0 right-0 bg-white">
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="p-7 flex gap-3.5 border-t border-[#D9D9D9]">
            <button className="text-center rounded-[50px] px-7.5 py-1.5 border border-black text-[12px] cursor-pointer transition-all duration-200 hover:bg-black hover:text-white">
              Cart
            </button>
            <button className="text-center rounded-[50px] px-7.5 py-1.5 border border-black text-[12px] cursor-pointer transition-all duration-200 hover:bg-black hover:text-white">
              Checkout
